...
<template>
    <UserAuthenticatedLayout title="Offers">
        <div class="flex flex-col w-full text-gray-700 items-center min-h-dvh">
            <div class="relative max-h-svh overflow-y-hidden">
                <div class="absolute max-w-lg min-h-svh pt-20 ml-10">
                    ...
                    <p class="mt-4 text-xl text-gray-700">
                        Refresh your wardrobe with our exclusive year-end offers! Enjoy unbeatable deals on our high-quality, ethically crafted pieces.
                    </p>
                </div>
                <img
                    :src="asset('images/offers-banner.jpg')" 
                    alt=""
                >
            </div>
