import { mergeProps, useSSRContext, useModel } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      let _temp0;
      _push(`<input${ssrRenderAttrs((_temp0 = mergeProps({ class: "rounded-md border-gray-300 shadow-sm focus:border-[#00adb5] focus:ring-[#00adb5]" }, _attrs), mergeProps(_temp0, ssrGetDynamicModelProps(_temp0, model.value))))}>`);
    };
  }
};
