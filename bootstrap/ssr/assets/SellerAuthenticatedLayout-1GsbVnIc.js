...
import { ClipboardDocumentListIcon, ClipboardDocumentIcon, BellIcon } from "@heroicons/vue/24/outline";
import { ChevronDownIcon } from "@heroicons/vue/20/solid";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-1tPrXgE0.js";
const _sfc_main = {
  __name: "SellerAuthenticatedLayout",
  ...
  setup(__props) {
    const parentMenuList = computed(() => {
      ...
      return [
        ...
        { name: "Order", id: "order", href: "/manage-orders" },
    ...
    const subMenuList = computed(() => {
      ...
      return {
        "Inventory": [
          { name: "List", id: "list", description: "List all products registered in the inventory.", href: "/product", icon: ClipboardDocumentListIcon },
          { name: "Register", id: "create", description: "Register a new product to the inventory.", href: "/product/create", icon: ClipboardDocumentIcon }
        ],
        ...user ? {
          [user.name]: [
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="flex flex-col h-screen" data-v-03ec6dca><div class="sticky" data-v-03ec6dca><nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" data-v-03ec6dca><div class="flex lg:flex-1" data-v-03ec6dca>`);
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      if (subMenuList.value[parentMenu.name]) {
                        ...
                        _push3(`<div data-v-03ec6dca${_scopeId2}>`);
                      ...
                      _push3(ssrRenderComponent(unref(PopoverPanel), { class: "absolute -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-gray-900/5 shifted-panel" }, {
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(`<div data-v-03ec6dca${_scopeId3}><!--[-->`);
                            ssrRenderList(subMenuList.value[parentMenu.name], (subMenu) => {
                              _push4(ssrRenderComponent(unref(Link), {
                                ...
                                default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                  if (_push5) {
                                    _push5(`<div class="flex size-11 flex-none items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white" data-v-03ec6dca${_scopeId4}>`);
                                    ...
                                    _push5(`</div><div class="flex-auto" data-v-03ec6dca${_scopeId4}><p class="block text-gray-900" data-v-03ec6dca${_scopeId4}>${ssrInterpolate(subMenu.name)}</p><p class="mt-1 text-gray-600" data-v-03ec6dca${_scopeId4}>${ssrInterpolate(subMenu.description)}</p></div>`);
                                  } else {
                                    return [
      ...
      if (_ctx.$page.props.canLogin) {
        _push(`<div class="flex flex-1 justify-end" data-v-03ec6dca>`);
        if (_ctx.$page.props.auth.user) {
          _push(`<div class="flex justify-around items-center flex-row gap-5" data-v-03ec6dca>`);
          _push(ssrRenderComponent(unref(Link), { href: "#" }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ssrRenderVNode(_push2, createVNode(resolveDynamicComponent(unref(BellIcon)), { class: "size-6 text-gray-900" }, null), _parent2, _scopeId);
              } else {
                return [
                  (openBlock(), createBlock(resolveDynamicComponent(unref(BellIcon)), { class: "size-6 text-gray-900" }))
                ];
              }
            }),
            _: 1
                  ...
                  _push2(ssrRenderComponent(unref(Popover), {
                    ...
                    default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                      if (_push3) {
                        ...
                        _push3(``);
                        _push3(ssrRenderComponent(unref(PopoverPanel), { class: "absolute over-width top-full z-10 max-w-md overflow-hidden rounded-lg bg-white shadow-lg ring-1 ring-gray-900/5" }, {
                          default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                            if (_push4) {
                              _push4(`<!--[-->`);
                              ssrRenderList(subMenuList.value[parentMenu.name], (subMenu) => {
                        ...
                        return [
                          ...
                          createVNode(Transition, {
                            ...
                            default: withCtx(() => [
                              createVNode(unref(PopoverPanel), { class: "absolute over-width top-full z-10 max-w-md overflow-hidden rounded-lg bg-white shadow-lg ring-1 ring-gray-900/5" }, {
                                default: withCtx(() => [
                                  (openBlock(true), createBlock(Fragment, null, renderList(subMenuList.value[parentMenu.name], (subMenu) => {
                                    return openBlock(), createBlock(unref(Link), {
                                      class: "flex flex-col items-start w-full rounded-lg px-4 py-3 text-sm/6 text-gray-900 hover:bg-gray-50",
      ...
      _push(`<div class="overflow-auto scrollbar-hide" data-v-03ec6dca>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Layouts/SellerAuthenticatedLayout.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const SellerAuthenticatedLayout = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-03ec6dca"]]);
export {
  SellerAuthenticatedLayout as S
};
