  ...
  setup(__props) {
    ...
    const filteredProducts = computed(() => {
      if (selectedCategory.value > 1) {
        return props.discountedProducts.filter(
          (product) => product["category"]["id"] === selectedCategory.value
        );
      } else {
        return props.discountedProducts;
      }
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(UserAuthenticatedLayout, mergeProps({ title: "Offers" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex flex-col w-full text-gray-700 items-center min-h-dvh"${_scopeId}><div class="relative max-h-svh overflow-y-hidden"${_scopeId}><div class="absolute max-w-lg min-h-svh pt-20 ml-10"${_scopeId}><h1 class="text-6xl font-bold tracking-tight text-gray-900"${_scopeId}> Year-End Clearance </h1><p class="mt-4 text-xl text-gray-700"${_scopeId}> Refresh your wardrobe with our exclusive year-end offers! Enjoy unbeatable deals on our high-quality, ethically crafted pieces. </p></div><img${ssrRenderAttr("src", _ctx.asset("images/offers-banner.jpg"))} alt=""${_scopeId}></div><div class="sticky top-0 flex justify-between w-full px-10 py-5 shadow-md items-center bg-white overflow-y-visible z-20"${_scopeId}><div class="w-full flex justify-start"${_scopeId}>`);
            ...
            return [
              createVNode("div", { class: "flex flex-col w-full text-gray-700 items-center min-h-dvh" }, [
                createVNode("div", { class: "relative max-h-svh overflow-y-hidden" }, [
                  createVNode("div", { class: "absolute max-w-lg min-h-svh pt-20 ml-10" }, [
                    createVNode("h1", { class: "text-6xl font-bold tracking-tight text-gray-900" }, " Year-End Clearance "),
                    createVNode("p", { class: "mt-4 text-xl text-gray-700" }, " Refresh your wardrobe with our exclusive year-end offers! Enjoy unbeatable deals on our high-quality, ethically crafted pieces. ")
                  ]),
                  createVNode("img", {
                    src: _ctx.asset("images/offers-banner.jpg"),
                    alt: ""
                  }, null, 8, ["src"])
                ]),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Buyer/Offers.vue");
